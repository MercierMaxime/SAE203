...
<template>
  ...
  <div class="bg-gradient-to-bl from-indigo-500 to-sky-400 pt-6">
    <div class="m-auto flex w-4/5 flex-col items-center justify-center gap-4 rounded-lg bg-white">
      ...
      >
        <p class="flex text-center font-bold text-black sm:text-xl lg:text-3xl xl:text-5xl">Jean FERRAT par Hervé ROGNARD</p>
      </div>
    ...
    <div class="relative m-auto mt-16 flex w-4/5 flex-col items-center justify-center pb-10">
      ...
      >
        ...
        <p class="flex-grow self-stretch text-center text-2xl">
          <span class="flex-grow self-stretch text-center text-base text-white">Né à Argentueil, France</span>
        </p>

        <p class="flex-grow self-stretch text-center text-2xl">
          <span class="flex-grow self-stretch text-center text-base text-white">Age : 35 ans </span>
        </p>

        <p class="flex-grow self-stretch text-center text-2xl">
          <span class="flex-grow self-stretch text-center text-base text-white"
            >Diplôme supérieur en musique (Spécialité : Technique Vocale)
          </span>
        </p>

        <p class="flex-grow self-stretch text-center text-2xl">
          <span class="flex-grow self-stretch text-center text-base text-white">Chanteur depuis 15 ans </span>
        </p>

        <p class="flex-grow self-stretch text-center text-2xl">
          <span class="flex-grow self-stretch text-center text-base text-white">Interpréteur de Jean FERRAT </span>
        </p>
